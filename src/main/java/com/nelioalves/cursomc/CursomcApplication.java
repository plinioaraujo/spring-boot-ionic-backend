...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat5 = new Categoria(null, "Livraria");
		Categoria cat6 = new Categoria(null, "Eletrônico");
		Categoria cat7 = new Categoria(null, "Instrumentos Musicais");
		Categoria cat8 = new Categoria(null, "Doces");
		Categoria cat9 = new Categoria(null, "Carnes");
		Categoria cat10 = new Categoria(null, "Refrigerados");
		Categoria cat11 = new Categoria(null, "Hortifrutti");
		Categoria cat12 = new Categoria(null, "Utilidades");
		Categoria cat13 = new Categoria(null, "Limpeza");
		Categoria cat14 = new Categoria(null, "Vestuário");
		Categoria cat15 = new Categoria(null, "Móveis");
		Categoria cat16 = new Categoria(null, "Computadores");
